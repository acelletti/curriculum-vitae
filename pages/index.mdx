...
<div class="page py-12 px-12">
  <div class="flex flex-row gap-10">
    ...
    A highly skilled and adaptable Full-Stack Engineer with strong experience in leadership and a proven track record of innovation and problem-solving.

    Experienced in building scalable applications with cloud and DevOps integration.: Passionate about optimizing engineering processes, improving performance, and leveraging modern frameworks to enhance system reliability and scalability.

    A strategic problem solver with a history of tackling complex challenges and optimizing system efficiency. Credited on multiple patents for innovations in network design.

...
<div class="page py-12 px-12">
  <div class="flex flex-row gap-10">
    ...
    I have been named on several patents regarding the application of Genetic Algorithms to solving network design problems for both capacity planning and cost driven optimisation.
    ...
    <div class="basis-[280px] flex flex-col">
        <div class="flex flex-row justify-center items-center h-[136px]">
            ...
            <div class="w-full h-full bg-center bg-cover bg-no-repeat" style="background-image: url('/img/profile.png')"></div>
            </div>
        </div>
